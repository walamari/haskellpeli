...
/* package haskellPeli-0.1.0.0 */
#ifndef VERSION_haskellPeli
#define VERSION_haskellPeli "0.1.0.0"
#endif /* VERSION_haskellPeli */
#ifndef MIN_VERSION_haskellPeli
#define MIN_VERSION_haskellPeli(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskellPeli */
...
#define CURRENT_COMPONENT_ID "haskellPeli-0.1.0.0-5l0FIzYI4rkDorqiRJVfxY-haskellPeli"
